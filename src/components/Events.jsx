...
const Events = () => {
	...
	return (
		<div className="Apps bg-black/5 backdrop-blur-sm flex text-white p-16 max-md:flex-col max-md:p-5 gap-16 max-md:gap-10 max-md:h-full max-md:w-full h-screen w-full flex-shrink-0 justify-center items-end ">
			{/* Left Section */}
